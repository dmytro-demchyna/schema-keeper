...
';
     ...
     * @expectedExceptionMessage Some functions have diff between their definitions before deploy and their definitions after deploy: public.trig_test(); public.trig_test().
     */
